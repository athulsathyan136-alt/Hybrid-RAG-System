...
app = FastAPI(
    title="RAG Evaluation Dashboard API",
...
def evaluate(request: EvaluationRequest):
    ...
    # --------------------------------------------------
    # 6. HALLUCINATION PERCENTAGE
    # --------------------------------------------------

    if sentences:
        hallucination_percentage = round(
            100 - citation_coverage,
            2
        )
    else:
    ...
    return {
        ...
        "sentence_analysis": {
            ...
            "unsupported_sentences": (
                len(sentences) - supported_sentences
            ),
            "support_threshold": 25.0,
